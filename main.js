...
randome_number = Math.floor((Math.random()*quick_draw_data_set.length)+1);
sketch = quick_draw_data_set[randome_number];
...
function check_sketch(){
    time_count++;
    document.getElementById("time").innerHTML = "Time : " + time_count;
